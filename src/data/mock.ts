...
export const comunidades: Comunidade[] = [
  ...
  { slug: "orkut-raiz-instagram-pela-metade", nome: "Orkut raiz, Instagram pela metade", membros: "22 mil", descricao: "A casa do Deu Pingo.", cor: "#89C4E1" },
...
export const topicos: Topico[] = [
  ...
  },
  {
    ...
    respostas: [{ autorId: "leticia", texto: "Pode. Se for mútuo, Deu Pingo." }],
  },
];
